 ...
 */
class plugins_apisports_admin extends plugins_apisports_db
{
    ...
    public function __construct()
    {
        ...
        if (http_request::isPost('apiasData')) {
            $this->apiasData = $formClean->arrayClean($_POST['apiasData']);
        }
    }
    /**
    ...
    {
        return $this->template->getConfigVars('apisports_plugin');
    }
    /**
    ...
    private function save(){
        ...
        $newData['url_as'] = $this->apiasData['url_as'];
        $newData['key_as'] = $this->apiasData['key_as'];
        ...
        if($setData['id_as']){
            ...
            $this->upd(
                array(
                    'type' => 'config',
                    'data' => array(
                        'url_as'     =>  $newData['url_as'],
                        'key_as'     =>  $newData['key_as'],
                        'id'             =>  $setData['id_as'],
                    )
                )
            );
    ...
    public function run(){
        if(isset($this->action)) {
            ...
            $this->template->assign('apias', $data);
